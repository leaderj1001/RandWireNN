...
def main():
    ...
    parser.add_argument('--model-mode', type=str, default="CIFAR100", help='which network you use, (example: CIFAR10, CIFAR100, SMALL_REGIME, REGULAR_REGIME), (default: CIFAR10)')
    parser.add_argument('--batch-size', type=int, default=16, help='batch size, (default: 100)')
    parser.add_argument('--dataset-mode', type=str, default="CIFAR100", help="which dataset you use, (example: CIFAR10, CIFAR100, MNIST), (default: CIFAR10)")
